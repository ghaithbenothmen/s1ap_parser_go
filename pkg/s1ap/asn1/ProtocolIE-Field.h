...
typedef enum Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_PR {
	Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_PR_NOTHING,	/* No components present */
	Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_PR_Bearers_SubjectToEarlyStatusTransfer_Item
} Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_PR;
typedef enum DAPSResponseInfoListIEs__value_PR {
	DAPSResponseInfoListIEs__value_PR_NOTHING,	/* No components present */
	DAPSResponseInfoListIEs__value_PR_DAPSResponseInfoItem
} DAPSResponseInfoListIEs__value_PR;
...
typedef enum E_RABSecurityResultListIEs__value_PR {
	E_RABSecurityResultListIEs__value_PR_NOTHING,	/* No components present */
	E_RABSecurityResultListIEs__value_PR_E_RABSecurityResultItem
} E_RABSecurityResultListIEs__value_PR;
...
typedef enum SourceNodeID_ExtensionIE__value_PR {
	SourceNodeID_ExtensionIE__value_PR_NOTHING	/* No components present */
	
} SourceNodeID_ExtensionIE__value_PR;
...
typedef enum HandoverRequestIEs__value_PR {
	...
	HandoverRequestIEs__value_PR_AdditionalRRMPriorityIndex,
...
typedef enum HandoverNotifyIEs__value_PR {
	...
	HandoverNotifyIEs__value_PR_NotifySourceeNB,
	HandoverNotifyIEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum PathSwitchRequestIEs__value_PR {
	...
	PathSwitchRequestIEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum PathSwitchRequestAcknowledgeIEs__value_PR {
	...
	PathSwitchRequestAcknowledgeIEs__value_PR_AdditionalRRMPriorityIndex,
	...
	PathSwitchRequestAcknowledgeIEs__value_PR_E_RABToBeUpdatedList
...
typedef enum HandoverSuccessIEs__value_PR {
	...
	HandoverSuccessIEs__value_PR_MME_UE_S1AP_ID,
	HandoverSuccessIEs__value_PR_ENB_UE_S1AP_ID
} HandoverSuccessIEs__value_PR;
typedef enum ENBEarlyStatusTransferIEs__value_PR {
	ENBEarlyStatusTransferIEs__value_PR_NOTHING,	/* No components present */
	ENBEarlyStatusTransferIEs__value_PR_MME_UE_S1AP_ID,
	ENBEarlyStatusTransferIEs__value_PR_ENB_UE_S1AP_ID,
	ENBEarlyStatusTransferIEs__value_PR_ENB_EarlyStatusTransfer_TransparentContainer
} ENBEarlyStatusTransferIEs__value_PR;
typedef enum MMEEarlyStatusTransferIEs__value_PR {
	MMEEarlyStatusTransferIEs__value_PR_NOTHING,	/* No components present */
	MMEEarlyStatusTransferIEs__value_PR_MME_UE_S1AP_ID,
	MMEEarlyStatusTransferIEs__value_PR_ENB_UE_S1AP_ID,
	MMEEarlyStatusTransferIEs__value_PR_ENB_EarlyStatusTransfer_TransparentContainer
} MMEEarlyStatusTransferIEs__value_PR;
...
typedef enum E_RABSetupResponseIEs__value_PR {
	...
	E_RABSetupResponseIEs__value_PR_UserLocationInformation
...
typedef enum E_RABModifyResponseIEs__value_PR {
	...
	E_RABModifyResponseIEs__value_PR_UserLocationInformation
...
typedef enum InitialContextSetupRequestIEs__value_PR {
	...
	InitialContextSetupRequestIEs__value_PR_AdditionalRRMPriorityIndex,
...
typedef enum UERadioCapabilityMatchRequestIEs__value_PR {
	...
	UERadioCapabilityMatchRequestIEs__value_PR_UERadioCapabilityID
...
typedef enum DownlinkNASTransport_IEs__value_PR {
	...
	DownlinkNASTransport_IEs__value_PR_AdditionalRRMPriorityIndex,
	DownlinkNASTransport_IEs__value_PR_UERadioCapabilityID,
	DownlinkNASTransport_IEs__value_PR_Masked_IMEISV
...
typedef enum InitialUEMessage_IEs__value_PR {
	...
	InitialUEMessage_IEs__value_PR_IAB_Node_Indication,
	InitialUEMessage_IEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum UplinkNASTransport_IEs__value_PR {
	...
	UplinkNASTransport_IEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum ErrorIndicationIEs__value_PR {
	...
	ErrorIndicationIEs__value_PR_S_TMSI
...
typedef enum S1SetupResponseIEs__value_PR {
	...
	S1SetupResponseIEs__value_PR_IAB_Supported
...
typedef enum UECapabilityInfoIndicationIEs__value_PR {
	...
	UECapabilityInfoIndicationIEs__value_PR_UERadioCapability_1,
	UECapabilityInfoIndicationIEs__value_PR_UERadioCapabilityForPaging_1
...
typedef enum LocationReportIEs__value_PR {
	...
	LocationReportIEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum ENBConfigurationTransferIEs__value_PR {
	...
	ENBConfigurationTransferIEs__value_PR_IntersystemSONConfigurationTransfer
...
typedef enum MMEConfigurationTransferIEs__value_PR {
	...
	MMEConfigurationTransferIEs__value_PR_IntersystemSONConfigurationTransfer
...
typedef enum E_RABModificationIndicationIEs__value_PR {
	...
	E_RABModificationIndicationIEs__value_PR_UserLocationInformation
...
typedef enum ConnectionEstablishmentIndicationIEs__value_PR {
	...
	ConnectionEstablishmentIndicationIEs__value_PR_E_RABLevelQoSParameters,
	ConnectionEstablishmentIndicationIEs__value_PR_UERadioCapabilityID,
	ConnectionEstablishmentIndicationIEs__value_PR_Masked_IMEISV
...
typedef enum UEInformationTransferIEs__value_PR {
	...
	UEInformationTransferIEs__value_PR_Masked_IMEISV
...
typedef enum ENBCPRelocationIndicationIEs__value_PR {
	...
	ENBCPRelocationIndicationIEs__value_PR_LTE_NTN_TAI_Information
...
typedef enum E_RABToBeUpdatedItemIEs__value_PR {
	E_RABToBeUpdatedItemIEs__value_PR_NOTHING,	/* No components present */
	E_RABToBeUpdatedItemIEs__value_PR_E_RABToBeUpdatedItem
} E_RABToBeUpdatedItemIEs__value_PR;
...
typedef struct Bearers_SubjectToEarlyStatusTransfer_ItemIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value {
		Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_PR present;
		union Bearers_SubjectToEarlyStatusTransfer_ItemIEs__value_u {
			Bearers_SubjectToEarlyStatusTransfer_Item_t	 Bearers_SubjectToEarlyStatusTransfer_Item;
		} choice;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} Bearers_SubjectToEarlyStatusTransfer_ItemIEs_t;
typedef struct DAPSResponseInfoListIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct DAPSResponseInfoListIEs__value {
		DAPSResponseInfoListIEs__value_PR present;
		union DAPSResponseInfoListIEs__value_u {
			DAPSResponseInfoItem_t	 DAPSResponseInfoItem;
		} choice;
...
typedef struct E_RABSecurityResultListIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct E_RABSecurityResultListIEs__value {
		E_RABSecurityResultListIEs__value_PR present;
		union E_RABSecurityResultListIEs__value_u {
			E_RABSecurityResultItem_t	 E_RABSecurityResultItem;
		} choice;
...
typedef struct SourceNodeID_ExtensionIE {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct SourceNodeID_ExtensionIE__value {
		SourceNodeID_ExtensionIE__value_PR present;
		union SourceNodeID_ExtensionIE__value_u {
		} choice;
...
typedef struct HandoverNotifyIEs {
	...
	struct HandoverNotifyIEs__value {
		...
		union HandoverNotifyIEs__value_u {
			...
			NotifySourceeNB_t	 NotifySourceeNB;
...
typedef struct PathSwitchRequestAcknowledgeIEs {
	...
	struct PathSwitchRequestAcknowledgeIEs__value {
		...
		union PathSwitchRequestAcknowledgeIEs__value_u {
			...
			UERadioCapabilityID_t	 UERadioCapabilityID;
			UESecurityCapabilities_t	 UESecurityCapabilities;
			E_RABToBeUpdatedList_t	 E_RABToBeUpdatedList;
		} choice;
...
typedef struct ENBEarlyStatusTransferIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct ENBEarlyStatusTransferIEs__value {
		ENBEarlyStatusTransferIEs__value_PR present;
		union ENBEarlyStatusTransferIEs__value_u {
			MME_UE_S1AP_ID_t	 MME_UE_S1AP_ID;
			ENB_UE_S1AP_ID_t	 ENB_UE_S1AP_ID;
			ENB_EarlyStatusTransfer_TransparentContainer_t	 ENB_EarlyStatusTransfer_TransparentContainer;
		} choice;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ENBEarlyStatusTransferIEs_t;
typedef struct MMEEarlyStatusTransferIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct MMEEarlyStatusTransferIEs__value {
		MMEEarlyStatusTransferIEs__value_PR present;
		union MMEEarlyStatusTransferIEs__value_u {
			MME_UE_S1AP_ID_t	 MME_UE_S1AP_ID;
			ENB_UE_S1AP_ID_t	 ENB_UE_S1AP_ID;
			ENB_EarlyStatusTransfer_TransparentContainer_t	 ENB_EarlyStatusTransfer_TransparentContainer;
		} choice;
...
typedef struct InitialUEMessage_IEs {
	...
	struct InitialUEMessage_IEs__value {
		...
		union InitialUEMessage_IEs__value_u {
			...
			IAB_Node_Indication_t	 IAB_Node_Indication;
			LTE_NTN_TAI_Information_t	 LTE_NTN_TAI_Information;
		} choice;
...
typedef struct UECapabilityInfoIndicationIEs {
	...
	struct UECapabilityInfoIndicationIEs__value {
		...
		union UECapabilityInfoIndicationIEs__value_u {
			...
			UERadioCapabilityForPaging_t	 UERadioCapabilityForPaging_1;
		} choice;
...
typedef struct E_RABToBeUpdatedItemIEs {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct E_RABToBeUpdatedItemIEs__value {
		E_RABToBeUpdatedItemIEs__value_PR present;
		union E_RABToBeUpdatedItemIEs__value_u {
			E_RABToBeUpdatedItem_t	 E_RABToBeUpdatedItem;
		} choice;
...
extern asn_TYPE_descriptor_t asn_DEF_Bearers_SubjectToEarlyStatusTransfer_ItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_Bearers_SubjectToEarlyStatusTransfer_ItemIEs_specs_49;
extern asn_TYPE_member_t asn_MBR_Bearers_SubjectToEarlyStatusTransfer_ItemIEs_49[3];
extern asn_TYPE_descriptor_t asn_DEF_DAPSResponseInfoListIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_DAPSResponseInfoListIEs_specs_53;
extern asn_TYPE_member_t asn_MBR_DAPSResponseInfoListIEs_53[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABInformationListIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABInformationListIEs_specs_57;
extern asn_TYPE_member_t asn_MBR_E_RABInformationListIEs_57[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABItemIEs_specs_61;
extern asn_TYPE_member_t asn_MBR_E_RABItemIEs_61[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABSecurityResultListIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABSecurityResultListIEs_specs_65;
extern asn_TYPE_member_t asn_MBR_E_RABSecurityResultListIEs_65[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABUsageReportItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABUsageReportItemIEs_specs_69;
extern asn_TYPE_member_t asn_MBR_E_RABUsageReportItemIEs_69[3];
extern asn_TYPE_descriptor_t asn_DEF_EventTrigger_ExtIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_EventTrigger_ExtIEs_specs_73;
extern asn_TYPE_member_t asn_MBR_EventTrigger_ExtIEs_73[3];
extern asn_TYPE_descriptor_t asn_DEF_MDTMode_ExtensionIE;
extern asn_SEQUENCE_specifics_t asn_SPC_MDTMode_ExtensionIE_specs_77;
extern asn_TYPE_member_t asn_MBR_MDTMode_ExtensionIE_77[3];
extern asn_TYPE_descriptor_t asn_DEF_MeasurementThresholdL1LoggedMDT_ExtIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MeasurementThresholdL1LoggedMDT_ExtIEs_specs_81;
extern asn_TYPE_member_t asn_MBR_MeasurementThresholdL1LoggedMDT_ExtIEs_81[3];
extern asn_TYPE_descriptor_t asn_DEF_RecommendedCellItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RecommendedCellItemIEs_specs_85;
extern asn_TYPE_member_t asn_MBR_RecommendedCellItemIEs_85[3];
extern asn_TYPE_descriptor_t asn_DEF_RecommendedENBItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RecommendedENBItemIEs_specs_89;
extern asn_TYPE_member_t asn_MBR_RecommendedENBItemIEs_89[3];
extern asn_TYPE_descriptor_t asn_DEF_SecondaryRATDataUsageReportItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_SecondaryRATDataUsageReportItemIEs_specs_93;
extern asn_TYPE_member_t asn_MBR_SecondaryRATDataUsageReportItemIEs_93[3];
extern asn_TYPE_descriptor_t asn_DEF_SensorNameConfig_ExtIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_SensorNameConfig_ExtIEs_specs_97;
extern asn_TYPE_member_t asn_MBR_SensorNameConfig_ExtIEs_97[3];
extern asn_TYPE_descriptor_t asn_DEF_SONInformation_ExtensionIE;
extern asn_SEQUENCE_specifics_t asn_SPC_SONInformation_ExtensionIE_specs_101;
extern asn_TYPE_member_t asn_MBR_SONInformation_ExtensionIE_101[3];
extern asn_TYPE_descriptor_t asn_DEF_SourceNodeID_ExtensionIE;
extern asn_SEQUENCE_specifics_t asn_SPC_SourceNodeID_ExtensionIE_specs_105;
extern asn_TYPE_member_t asn_MBR_SourceNodeID_ExtensionIE_105[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverRequiredIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverRequiredIEs_specs_109;
extern asn_TYPE_member_t asn_MBR_HandoverRequiredIEs_109[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverCommandIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverCommandIEs_specs_113;
extern asn_TYPE_member_t asn_MBR_HandoverCommandIEs_113[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverPreparationFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverPreparationFailureIEs_specs_117;
extern asn_TYPE_member_t asn_MBR_HandoverPreparationFailureIEs_117[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverRequestIEs_specs_121;
extern asn_TYPE_member_t asn_MBR_HandoverRequestIEs_121[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverRequestAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverRequestAcknowledgeIEs_specs_125;
extern asn_TYPE_member_t asn_MBR_HandoverRequestAcknowledgeIEs_125[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverFailureIEs_specs_129;
extern asn_TYPE_member_t asn_MBR_HandoverFailureIEs_129[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverNotifyIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverNotifyIEs_specs_133;
extern asn_TYPE_member_t asn_MBR_HandoverNotifyIEs_133[3];
extern asn_TYPE_descriptor_t asn_DEF_PathSwitchRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PathSwitchRequestIEs_specs_137;
extern asn_TYPE_member_t asn_MBR_PathSwitchRequestIEs_137[3];
extern asn_TYPE_descriptor_t asn_DEF_PathSwitchRequestAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PathSwitchRequestAcknowledgeIEs_specs_141;
extern asn_TYPE_member_t asn_MBR_PathSwitchRequestAcknowledgeIEs_141[3];
extern asn_TYPE_descriptor_t asn_DEF_PathSwitchRequestFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PathSwitchRequestFailureIEs_specs_145;
extern asn_TYPE_member_t asn_MBR_PathSwitchRequestFailureIEs_145[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverCancelIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverCancelIEs_specs_149;
extern asn_TYPE_member_t asn_MBR_HandoverCancelIEs_149[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverCancelAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverCancelAcknowledgeIEs_specs_153;
extern asn_TYPE_member_t asn_MBR_HandoverCancelAcknowledgeIEs_153[3];
extern asn_TYPE_descriptor_t asn_DEF_HandoverSuccessIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverSuccessIEs_specs_157;
extern asn_TYPE_member_t asn_MBR_HandoverSuccessIEs_157[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBEarlyStatusTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBEarlyStatusTransferIEs_specs_161;
extern asn_TYPE_member_t asn_MBR_ENBEarlyStatusTransferIEs_161[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEEarlyStatusTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEEarlyStatusTransferIEs_specs_165;
extern asn_TYPE_member_t asn_MBR_MMEEarlyStatusTransferIEs_165[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABSetupRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABSetupRequestIEs_specs_169;
extern asn_TYPE_member_t asn_MBR_E_RABSetupRequestIEs_169[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABSetupResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABSetupResponseIEs_specs_173;
extern asn_TYPE_member_t asn_MBR_E_RABSetupResponseIEs_173[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABModifyRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABModifyRequestIEs_specs_177;
extern asn_TYPE_member_t asn_MBR_E_RABModifyRequestIEs_177[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABModifyResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABModifyResponseIEs_specs_181;
extern asn_TYPE_member_t asn_MBR_E_RABModifyResponseIEs_181[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABReleaseCommandIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABReleaseCommandIEs_specs_185;
extern asn_TYPE_member_t asn_MBR_E_RABReleaseCommandIEs_185[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABReleaseResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABReleaseResponseIEs_specs_189;
extern asn_TYPE_member_t asn_MBR_E_RABReleaseResponseIEs_189[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABReleaseIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABReleaseIndicationIEs_specs_193;
extern asn_TYPE_member_t asn_MBR_E_RABReleaseIndicationIEs_193[3];
extern asn_TYPE_descriptor_t asn_DEF_InitialContextSetupRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_InitialContextSetupRequestIEs_specs_197;
extern asn_TYPE_member_t asn_MBR_InitialContextSetupRequestIEs_197[3];
extern asn_TYPE_descriptor_t asn_DEF_InitialContextSetupResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_InitialContextSetupResponseIEs_specs_201;
extern asn_TYPE_member_t asn_MBR_InitialContextSetupResponseIEs_201[3];
extern asn_TYPE_descriptor_t asn_DEF_InitialContextSetupFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_InitialContextSetupFailureIEs_specs_205;
extern asn_TYPE_member_t asn_MBR_InitialContextSetupFailureIEs_205[3];
extern asn_TYPE_descriptor_t asn_DEF_PagingIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PagingIEs_specs_209;
extern asn_TYPE_member_t asn_MBR_PagingIEs_209[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextReleaseRequest_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextReleaseRequest_IEs_specs_213;
extern asn_TYPE_member_t asn_MBR_UEContextReleaseRequest_IEs_213[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextReleaseCommand_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextReleaseCommand_IEs_specs_217;
extern asn_TYPE_member_t asn_MBR_UEContextReleaseCommand_IEs_217[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextReleaseComplete_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextReleaseComplete_IEs_specs_221;
extern asn_TYPE_member_t asn_MBR_UEContextReleaseComplete_IEs_221[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextModificationRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextModificationRequestIEs_specs_225;
extern asn_TYPE_member_t asn_MBR_UEContextModificationRequestIEs_225[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextModificationResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextModificationResponseIEs_specs_229;
extern asn_TYPE_member_t asn_MBR_UEContextModificationResponseIEs_229[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextModificationFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextModificationFailureIEs_specs_233;
extern asn_TYPE_member_t asn_MBR_UEContextModificationFailureIEs_233[3];
extern asn_TYPE_descriptor_t asn_DEF_UERadioCapabilityMatchRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UERadioCapabilityMatchRequestIEs_specs_237;
extern asn_TYPE_member_t asn_MBR_UERadioCapabilityMatchRequestIEs_237[3];
extern asn_TYPE_descriptor_t asn_DEF_UERadioCapabilityMatchResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UERadioCapabilityMatchResponseIEs_specs_241;
extern asn_TYPE_member_t asn_MBR_UERadioCapabilityMatchResponseIEs_241[3];
...
extern asn_SEQUENCE_specifics_t asn_SPC_UplinkNASTransport_IEs_specs_253;
extern asn_TYPE_member_t asn_MBR_UplinkNASTransport_IEs_253[3];
extern asn_TYPE_descriptor_t asn_DEF_NASNonDeliveryIndication_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_NASNonDeliveryIndication_IEs_specs_257;
extern asn_TYPE_member_t asn_MBR_NASNonDeliveryIndication_IEs_257[3];
extern asn_TYPE_descriptor_t asn_DEF_RerouteNASRequest_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RerouteNASRequest_IEs_specs_261;
extern asn_TYPE_member_t asn_MBR_RerouteNASRequest_IEs_261[3];
extern asn_TYPE_descriptor_t asn_DEF_NASDeliveryIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_NASDeliveryIndicationIEs_specs_265;
extern asn_TYPE_member_t asn_MBR_NASDeliveryIndicationIEs_265[3];
extern asn_TYPE_descriptor_t asn_DEF_ResetIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ResetIEs_specs_269;
extern asn_TYPE_member_t asn_MBR_ResetIEs_269[3];
extern asn_TYPE_descriptor_t asn_DEF_ResetAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ResetAcknowledgeIEs_specs_273;
extern asn_TYPE_member_t asn_MBR_ResetAcknowledgeIEs_273[3];
extern asn_TYPE_descriptor_t asn_DEF_ErrorIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ErrorIndicationIEs_specs_277;
extern asn_TYPE_member_t asn_MBR_ErrorIndicationIEs_277[3];
extern asn_TYPE_descriptor_t asn_DEF_S1SetupRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_S1SetupRequestIEs_specs_281;
extern asn_TYPE_member_t asn_MBR_S1SetupRequestIEs_281[3];
extern asn_TYPE_descriptor_t asn_DEF_S1SetupResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_S1SetupResponseIEs_specs_285;
extern asn_TYPE_member_t asn_MBR_S1SetupResponseIEs_285[3];
extern asn_TYPE_descriptor_t asn_DEF_S1SetupFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_S1SetupFailureIEs_specs_289;
extern asn_TYPE_member_t asn_MBR_S1SetupFailureIEs_289[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBConfigurationUpdateIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBConfigurationUpdateIEs_specs_293;
extern asn_TYPE_member_t asn_MBR_ENBConfigurationUpdateIEs_293[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBConfigurationUpdateAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBConfigurationUpdateAcknowledgeIEs_specs_297;
extern asn_TYPE_member_t asn_MBR_ENBConfigurationUpdateAcknowledgeIEs_297[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBConfigurationUpdateFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBConfigurationUpdateFailureIEs_specs_301;
extern asn_TYPE_member_t asn_MBR_ENBConfigurationUpdateFailureIEs_301[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEConfigurationUpdateIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEConfigurationUpdateIEs_specs_305;
extern asn_TYPE_member_t asn_MBR_MMEConfigurationUpdateIEs_305[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEConfigurationUpdateAcknowledgeIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEConfigurationUpdateAcknowledgeIEs_specs_309;
extern asn_TYPE_member_t asn_MBR_MMEConfigurationUpdateAcknowledgeIEs_309[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEConfigurationUpdateFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEConfigurationUpdateFailureIEs_specs_313;
extern asn_TYPE_member_t asn_MBR_MMEConfigurationUpdateFailureIEs_313[3];
extern asn_TYPE_descriptor_t asn_DEF_DownlinkS1cdma2000tunnellingIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_DownlinkS1cdma2000tunnellingIEs_specs_317;
extern asn_TYPE_member_t asn_MBR_DownlinkS1cdma2000tunnellingIEs_317[3];
extern asn_TYPE_descriptor_t asn_DEF_UplinkS1cdma2000tunnellingIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UplinkS1cdma2000tunnellingIEs_specs_321;
extern asn_TYPE_member_t asn_MBR_UplinkS1cdma2000tunnellingIEs_321[3];
extern asn_TYPE_descriptor_t asn_DEF_UECapabilityInfoIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UECapabilityInfoIndicationIEs_specs_325;
extern asn_TYPE_member_t asn_MBR_UECapabilityInfoIndicationIEs_325[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBStatusTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBStatusTransferIEs_specs_329;
extern asn_TYPE_member_t asn_MBR_ENBStatusTransferIEs_329[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEStatusTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEStatusTransferIEs_specs_333;
extern asn_TYPE_member_t asn_MBR_MMEStatusTransferIEs_333[3];
extern asn_TYPE_descriptor_t asn_DEF_TraceStartIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_TraceStartIEs_specs_337;
extern asn_TYPE_member_t asn_MBR_TraceStartIEs_337[3];
extern asn_TYPE_descriptor_t asn_DEF_TraceFailureIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_TraceFailureIndicationIEs_specs_341;
extern asn_TYPE_member_t asn_MBR_TraceFailureIndicationIEs_341[3];
extern asn_TYPE_descriptor_t asn_DEF_DeactivateTraceIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_DeactivateTraceIEs_specs_345;
extern asn_TYPE_member_t asn_MBR_DeactivateTraceIEs_345[3];
extern asn_TYPE_descriptor_t asn_DEF_CellTrafficTraceIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_CellTrafficTraceIEs_specs_349;
extern asn_TYPE_member_t asn_MBR_CellTrafficTraceIEs_349[3];
extern asn_TYPE_descriptor_t asn_DEF_LocationReportingControlIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_LocationReportingControlIEs_specs_353;
extern asn_TYPE_member_t asn_MBR_LocationReportingControlIEs_353[3];
extern asn_TYPE_descriptor_t asn_DEF_LocationReportingFailureIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_LocationReportingFailureIndicationIEs_specs_357;
extern asn_TYPE_member_t asn_MBR_LocationReportingFailureIndicationIEs_357[3];
extern asn_TYPE_descriptor_t asn_DEF_LocationReportIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_LocationReportIEs_specs_361;
extern asn_TYPE_member_t asn_MBR_LocationReportIEs_361[3];
extern asn_TYPE_descriptor_t asn_DEF_OverloadStartIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_OverloadStartIEs_specs_365;
extern asn_TYPE_member_t asn_MBR_OverloadStartIEs_365[3];
extern asn_TYPE_descriptor_t asn_DEF_OverloadStopIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_OverloadStopIEs_specs_369;
extern asn_TYPE_member_t asn_MBR_OverloadStopIEs_369[3];
extern asn_TYPE_descriptor_t asn_DEF_WriteReplaceWarningRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_WriteReplaceWarningRequestIEs_specs_373;
extern asn_TYPE_member_t asn_MBR_WriteReplaceWarningRequestIEs_373[3];
extern asn_TYPE_descriptor_t asn_DEF_WriteReplaceWarningResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_WriteReplaceWarningResponseIEs_specs_377;
extern asn_TYPE_member_t asn_MBR_WriteReplaceWarningResponseIEs_377[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBDirectInformationTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBDirectInformationTransferIEs_specs_381;
extern asn_TYPE_member_t asn_MBR_ENBDirectInformationTransferIEs_381[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEDirectInformationTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEDirectInformationTransferIEs_specs_385;
extern asn_TYPE_member_t asn_MBR_MMEDirectInformationTransferIEs_385[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBConfigurationTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBConfigurationTransferIEs_specs_389;
extern asn_TYPE_member_t asn_MBR_ENBConfigurationTransferIEs_389[3];
extern asn_TYPE_descriptor_t asn_DEF_MMEConfigurationTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMEConfigurationTransferIEs_specs_393;
extern asn_TYPE_member_t asn_MBR_MMEConfigurationTransferIEs_393[3];
extern asn_TYPE_descriptor_t asn_DEF_KillRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_KillRequestIEs_specs_397;
extern asn_TYPE_member_t asn_MBR_KillRequestIEs_397[3];
extern asn_TYPE_descriptor_t asn_DEF_KillResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_KillResponseIEs_specs_401;
extern asn_TYPE_member_t asn_MBR_KillResponseIEs_401[3];
extern asn_TYPE_descriptor_t asn_DEF_PWSRestartIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PWSRestartIndicationIEs_specs_405;
extern asn_TYPE_member_t asn_MBR_PWSRestartIndicationIEs_405[3];
extern asn_TYPE_descriptor_t asn_DEF_PWSFailureIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_PWSFailureIndicationIEs_specs_409;
extern asn_TYPE_member_t asn_MBR_PWSFailureIndicationIEs_409[3];
extern asn_TYPE_descriptor_t asn_DEF_DownlinkUEAssociatedLPPaTransport_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_DownlinkUEAssociatedLPPaTransport_IEs_specs_413;
extern asn_TYPE_member_t asn_MBR_DownlinkUEAssociatedLPPaTransport_IEs_413[3];
extern asn_TYPE_descriptor_t asn_DEF_UplinkUEAssociatedLPPaTransport_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UplinkUEAssociatedLPPaTransport_IEs_specs_417;
extern asn_TYPE_member_t asn_MBR_UplinkUEAssociatedLPPaTransport_IEs_417[3];
extern asn_TYPE_descriptor_t asn_DEF_DownlinkNonUEAssociatedLPPaTransport_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_DownlinkNonUEAssociatedLPPaTransport_IEs_specs_421;
extern asn_TYPE_member_t asn_MBR_DownlinkNonUEAssociatedLPPaTransport_IEs_421[3];
extern asn_TYPE_descriptor_t asn_DEF_UplinkNonUEAssociatedLPPaTransport_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UplinkNonUEAssociatedLPPaTransport_IEs_specs_425;
extern asn_TYPE_member_t asn_MBR_UplinkNonUEAssociatedLPPaTransport_IEs_425[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABModificationIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABModificationIndicationIEs_specs_429;
extern asn_TYPE_member_t asn_MBR_E_RABModificationIndicationIEs_429[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABModificationConfirmIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABModificationConfirmIEs_specs_433;
extern asn_TYPE_member_t asn_MBR_E_RABModificationConfirmIEs_433[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextModificationIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextModificationIndicationIEs_specs_437;
extern asn_TYPE_member_t asn_MBR_UEContextModificationIndicationIEs_437[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextModificationConfirmIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextModificationConfirmIEs_specs_441;
extern asn_TYPE_member_t asn_MBR_UEContextModificationConfirmIEs_441[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextSuspendRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextSuspendRequestIEs_specs_445;
extern asn_TYPE_member_t asn_MBR_UEContextSuspendRequestIEs_445[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextSuspendResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextSuspendResponseIEs_specs_449;
extern asn_TYPE_member_t asn_MBR_UEContextSuspendResponseIEs_449[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextResumeRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextResumeRequestIEs_specs_453;
extern asn_TYPE_member_t asn_MBR_UEContextResumeRequestIEs_453[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextResumeResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextResumeResponseIEs_specs_457;
extern asn_TYPE_member_t asn_MBR_UEContextResumeResponseIEs_457[3];
extern asn_TYPE_descriptor_t asn_DEF_UEContextResumeFailureIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEContextResumeFailureIEs_specs_461;
extern asn_TYPE_member_t asn_MBR_UEContextResumeFailureIEs_461[3];
extern asn_TYPE_descriptor_t asn_DEF_ConnectionEstablishmentIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ConnectionEstablishmentIndicationIEs_specs_465;
extern asn_TYPE_member_t asn_MBR_ConnectionEstablishmentIndicationIEs_465[3];
extern asn_TYPE_descriptor_t asn_DEF_RetrieveUEInformationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RetrieveUEInformationIEs_specs_469;
extern asn_TYPE_member_t asn_MBR_RetrieveUEInformationIEs_469[3];
extern asn_TYPE_descriptor_t asn_DEF_UEInformationTransferIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UEInformationTransferIEs_specs_473;
extern asn_TYPE_member_t asn_MBR_UEInformationTransferIEs_473[3];
extern asn_TYPE_descriptor_t asn_DEF_ENBCPRelocationIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_ENBCPRelocationIndicationIEs_specs_477;
extern asn_TYPE_member_t asn_MBR_ENBCPRelocationIndicationIEs_477[3];
extern asn_TYPE_descriptor_t asn_DEF_MMECPRelocationIndicationIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_MMECPRelocationIndicationIEs_specs_481;
extern asn_TYPE_member_t asn_MBR_MMECPRelocationIndicationIEs_481[3];
extern asn_TYPE_descriptor_t asn_DEF_SecondaryRATDataUsageReportIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_SecondaryRATDataUsageReportIEs_specs_485;
extern asn_TYPE_member_t asn_MBR_SecondaryRATDataUsageReportIEs_485[3];
extern asn_TYPE_descriptor_t asn_DEF_UERadioCapabilityIDMappingRequestIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UERadioCapabilityIDMappingRequestIEs_specs_489;
extern asn_TYPE_member_t asn_MBR_UERadioCapabilityIDMappingRequestIEs_489[3];
extern asn_TYPE_descriptor_t asn_DEF_UERadioCapabilityIDMappingResponseIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_UERadioCapabilityIDMappingResponseIEs_specs_493;
extern asn_TYPE_member_t asn_MBR_UERadioCapabilityIDMappingResponseIEs_493[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABDataForwardingItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABDataForwardingItemIEs_specs_497;
extern asn_TYPE_member_t asn_MBR_E_RABDataForwardingItemIEs_497[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABToBeSetupItemHOReqIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABToBeSetupItemHOReqIEs_specs_501;
extern asn_TYPE_member_t asn_MBR_E_RABToBeSetupItemHOReqIEs_501[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABAdmittedItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABAdmittedItemIEs_specs_505;
extern asn_TYPE_member_t asn_MBR_E_RABAdmittedItemIEs_505[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABFailedtoSetupItemHOReqAckIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABFailedtoSetupItemHOReqAckIEs_specs_509;
extern asn_TYPE_member_t asn_MBR_E_RABFailedtoSetupItemHOReqAckIEs_509[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABToBeSwitchedDLItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABToBeSwitchedDLItemIEs_specs_513;
extern asn_TYPE_member_t asn_MBR_E_RABToBeSwitchedDLItemIEs_513[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABToBeSwitchedULItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABToBeSwitchedULItemIEs_specs_517;
extern asn_TYPE_member_t asn_MBR_E_RABToBeSwitchedULItemIEs_517[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABToBeUpdatedItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABToBeUpdatedItemIEs_specs_521;
extern asn_TYPE_member_t asn_MBR_E_RABToBeUpdatedItemIEs_521[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABToBeModifiedItemBearerModIndIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABToBeModifiedItemBearerModIndIEs_specs_525;
extern asn_TYPE_member_t asn_MBR_E_RABToBeModifiedItemBearerModIndIEs_525[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABNotToBeModifiedItemBearerModIndIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABNotToBeModifiedItemBearerModIndIEs_specs_529;
extern asn_TYPE_member_t asn_MBR_E_RABNotToBeModifiedItemBearerModIndIEs_529[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABFailedToResumeItemResumeReqIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABFailedToResumeItemResumeReqIEs_specs_533;
extern asn_TYPE_member_t asn_MBR_E_RABFailedToResumeItemResumeReqIEs_533[3];
extern asn_TYPE_descriptor_t asn_DEF_E_RABFailedToResumeItemResumeResIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABFailedToResumeItemResumeResIEs_specs_537;
extern asn_TYPE_member_t asn_MBR_E_RABFailedToResumeItemResumeResIEs_537[3];
