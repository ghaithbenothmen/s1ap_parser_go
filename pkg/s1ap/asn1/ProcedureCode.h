...
#define ProcedureCode_id_UERadioCapabilityIDMapping	((ProcedureCode_t)63)
#define ProcedureCode_id_HandoverSuccess	((ProcedureCode_t)64)
#define ProcedureCode_id_eNBEarlyStatusTransfer	((ProcedureCode_t)65)
#define ProcedureCode_id_MMEEarlyStatusTransfer	((ProcedureCode_t)66)
