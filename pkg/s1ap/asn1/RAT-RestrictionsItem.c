...
static asn_jer_constraints_t asn_JER_memb_rAT_RestrictionInformation_constr_3 CC_NOTUSED = {
	-1};
...
asn_TYPE_member_t asn_MBR_RAT_RestrictionsItem_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_rAT_RestrictionInformation_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_rAT_RestrictionInformation_constr_3,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_rAT_RestrictionInformation_constraint_1
		},
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct RAT_RestrictionsItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_8194P119,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
