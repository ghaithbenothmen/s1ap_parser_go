...
#define ProtocolIE_ID_id_AdditionalRRMPriorityIndex	((ProtocolIE_ID_t)299)
#define ProtocolIE_ID_id_ContextatSource	((ProtocolIE_ID_t)300)
#define ProtocolIE_ID_id_IAB_Authorized	((ProtocolIE_ID_t)301)
#define ProtocolIE_ID_id_IAB_Node_Indication	((ProtocolIE_ID_t)302)
#define ProtocolIE_ID_id_IAB_Supported	((ProtocolIE_ID_t)303)
#define ProtocolIE_ID_id_DataSize	((ProtocolIE_ID_t)304)
#define ProtocolIE_ID_id_Ethernet_Type	((ProtocolIE_ID_t)305)
#define ProtocolIE_ID_id_NRV2XServicesAuthorized	((ProtocolIE_ID_t)306)
#define ProtocolIE_ID_id_NRUESidelinkAggregateMaximumBitrate	((ProtocolIE_ID_t)307)
#define ProtocolIE_ID_id_PC5QoSParameters	((ProtocolIE_ID_t)308)
#define ProtocolIE_ID_id_IntersystemSONConfigurationTransferMCT	((ProtocolIE_ID_t)309)
#define ProtocolIE_ID_id_IntersystemSONConfigurationTransferECT	((ProtocolIE_ID_t)310)
#define ProtocolIE_ID_id_IntersystemMeasurementConfiguration	((ProtocolIE_ID_t)311)
#define ProtocolIE_ID_id_SourceNodeID	((ProtocolIE_ID_t)312)
#define ProtocolIE_ID_id_NB_IoT_RLF_Report_Container	((ProtocolIE_ID_t)313)
#define ProtocolIE_ID_id_UERadioCapabilityID	((ProtocolIE_ID_t)314)
#define ProtocolIE_ID_id_UERadioCapability_NR_Format	((ProtocolIE_ID_t)315)
#define ProtocolIE_ID_id_MDTConfigurationNR	((ProtocolIE_ID_t)316)
#define ProtocolIE_ID_id_DAPSRequestInfo	((ProtocolIE_ID_t)317)
#define ProtocolIE_ID_id_DAPSResponseInfoList	((ProtocolIE_ID_t)318)
#define ProtocolIE_ID_id_DAPSResponseInfoItem	((ProtocolIE_ID_t)319)
#define ProtocolIE_ID_id_NotifySourceeNB	((ProtocolIE_ID_t)320)
#define ProtocolIE_ID_id_eNB_EarlyStatusTransfer_TransparentContainer	((ProtocolIE_ID_t)321)
#define ProtocolIE_ID_id_Bearers_SubjectToEarlyStatusTransfer_Item	((ProtocolIE_ID_t)322)
#define ProtocolIE_ID_id_WUS_Assistance_Information	((ProtocolIE_ID_t)323)
#define ProtocolIE_ID_id_NB_IoT_PagingDRX	((ProtocolIE_ID_t)324)
#define ProtocolIE_ID_id_TraceCollectionEntityURI	((ProtocolIE_ID_t)325)
#define ProtocolIE_ID_id_EmergencyIndicator	((ProtocolIE_ID_t)326)
#define ProtocolIE_ID_id_UERadioCapabilityForPaging_NR_Format	((ProtocolIE_ID_t)327)
#define ProtocolIE_ID_id_SourceTransportLayerAddress	((ProtocolIE_ID_t)328)
#define ProtocolIE_ID_id_lastVisitedPSCellList	((ProtocolIE_ID_t)329)
#define ProtocolIE_ID_id_RACSIndication	((ProtocolIE_ID_t)330)
#define ProtocolIE_ID_id_PagingCause	((ProtocolIE_ID_t)331)
#define ProtocolIE_ID_id_SecurityIndication	((ProtocolIE_ID_t)332)
#define ProtocolIE_ID_id_SecurityResult	((ProtocolIE_ID_t)333)
#define ProtocolIE_ID_id_E_RABSecurityResultItem	((ProtocolIE_ID_t)334)
#define ProtocolIE_ID_id_E_RABSecurityResultList	((ProtocolIE_ID_t)335)
#define ProtocolIE_ID_id_RAT_Restrictions	((ProtocolIE_ID_t)336)
#define ProtocolIE_ID_id_UEContextReferenceatSourceeNB	((ProtocolIE_ID_t)337)
#define ProtocolIE_ID_id_LTE_NTN_TAI_Information	((ProtocolIE_ID_t)339)
#define ProtocolIE_ID_id_SourceNodeTransportLayerAddress	((ProtocolIE_ID_t)340)
#define ProtocolIE_ID_id_E_RABToBeUpdatedList	((ProtocolIE_ID_t)341)
#define ProtocolIE_ID_id_E_RABToBeUpdatedItem	((ProtocolIE_ID_t)342)
#define ProtocolIE_ID_id_SourceSNID	((ProtocolIE_ID_t)343)
#define ProtocolIE_ID_id_LoggedMDTTrigger	((ProtocolIE_ID_t)344)
#define ProtocolIE_ID_id_SensorMeasurementConfiguration	((ProtocolIE_ID_t)345)
