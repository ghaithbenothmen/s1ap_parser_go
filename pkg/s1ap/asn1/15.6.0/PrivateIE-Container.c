...
static asn_oer_constraints_t asn_OER_type_PrivateIE_Container_7343P0_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..65535)) */};
...
asn_TYPE_member_t asn_MBR_PrivateIE_Container_7343P0_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_PrivateIE_Field_7346P0,
		0,
		{ 0, 0, 0 },
...
asn_TYPE_descriptor_t asn_DEF_PrivateIE_Container_7343P0 = {
	...
	sizeof(asn_DEF_PrivateIE_Container_7343P0_tags_1)
		/sizeof(asn_DEF_PrivateIE_Container_7343P0_tags_1[0]), /* 1 */
	{ &asn_OER_type_PrivateIE_Container_7343P0_constr_1, &asn_PER_type_PrivateIE_Container_7343P0_constr_1, SEQUENCE_OF_constraint },
