...
static asn_oer_constraints_t asn_OER_memb_minimumActivationTime_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..60) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CellActivationRequest_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellActivationRequest, minimumActivationTime),
		...
		0,
		{ &asn_OER_memb_minimumActivationTime_constr_3, &asn_PER_memb_minimumActivationTime_constr_3,  memb_minimumActivationTime_constraint_1 },
		0, 0, /* No default value */
